...
class AttribDataset(Dataset):
    ...
    def __init__(self, pathdb, attribDictPath=None, specificAttrib=None, transform=None, mimicImageFolder=False,
                 ignoreAttribs=False, getEqualizer=False, pathMask=None):
        r"""
        Args:
    ...
    def __getitem__(self, idx):
        ...
        if self.pathMask is not None:
            ...
            return img, paddle.to_tensor(attr, dtype=paddle.int64), mask

        return img, paddle.to_tensor(attr, dtype=paddle.int64)

...
def get_dataloader():
    with open('./configs/dfc_vae.yaml', 'r') as file:
    ...
    testloader = DataLoader(testset, batch_size=144, num_workers=0, shuffle=False, drop_last=False,use_buffer_reader=True)
    msg = 'load dataloader success'
    return trainloader, testloader, msg
